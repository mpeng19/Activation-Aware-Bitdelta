...
BASE_DIR="experiments/llama7b_calibration_stack"
mkdir -p $BASE_DIR
...
print("\nResults:")
print(df)
df.to_csv(f"{BASE_DIR}/stack_results.csv", index=False)
EOF
}
...
echo "All experiments complete! Results saved to $BASE_DIR/stack_results.csv"